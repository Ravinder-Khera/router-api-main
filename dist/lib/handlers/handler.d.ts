...
export declare type APIGatewayProxyHandler = (event: APIGatewayProxyEvent, context: Context) => Promise<APIGatewayProxyResult>;
export declare type BaseRInj = {
    log: Logger;
    id: string;
};
export declare type HandleRequestParams<CInj, RInj, ReqBody, ReqQueryParams> = {
    context: Context;
